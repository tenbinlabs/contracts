...
import {IMintableBurnable} from "src/interface/IMintableBurnable.sol";
...
contract AssetToken is IMintableBurnable, ERC20Permit, Ownable2Step {
    /// @notice Only minter
    error OnlyMinter();
    ...
    /// @notice Mint `amount` of tokens and increase `to` balance
